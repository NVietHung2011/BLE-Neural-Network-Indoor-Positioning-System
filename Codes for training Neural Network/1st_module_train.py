...
data = pd.read_csv(r'C:\Users\Admin\Desktop\KLTN_NN\KLTN_NN_8\data.csv')

test = pd.read_csv(r'C:\Users\Admin\Desktop\KLTN_NN\KLTN_NN_8\test.csv')
...
def init_parameters():
    # 16 inputs, 16 neurons in layer 1, 8 neurons in layer 2
    inw1 = np.random.rand(16, 16)  # weights of layer 1 is (16x16) shape
    inb1 = np.random.rand(16, 1)   # biases of layer 1 is (16x1) shape
    inw2 = np.random.rand(8, 16)   # weights of layer 2 is (8x16) shape
    inb2 = np.random.rand(8, 1)    # biases of layer 2 is (8x1) shape
...
def training(inputs, result, iterations, learning_rate):
    ...
    biases1 = np.load('b1.npy')
    biases2 = np.load('b2.npy')
    a = open('a.csv', 'a')
